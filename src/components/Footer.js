...
const Footer = () => {
  return (
    <div className="mt-10 text-sm p-3 border-t w-full bg-gray-200">
      <div className="max-w-2xl mx-auto flex-row flex justify-between">
        <div className="w-full text-gray-700 leading-relaxed">
          ...
          <a href="https://corona.jepara.go.id/" target='_blank' rel="noopener noreferrer" className="text-blue-600 hover:text-gray-600"> corona.jepara.go.id</a>
        </div>
      </div>
    </div>
  )
